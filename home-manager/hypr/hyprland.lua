...
local terminal    = "~/.config/scripts/open-kitty.sh"
...
hl.config({
    general = {
        ...
        col = {
            ...
            inactive_border = colors.background .. "ee",
        },
...
-- Default springs
hl.curve("easy",           { type = "spring", mass = 1, stiffness = 258.1191, dampening = 26.21279333 })
...
hl.animation({ leaf = "windowsOut",    enabled = true,  speed = 1.29, bezier = "linear",       style = "popin 87%" })
...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 1.41, bezier = "easeInOutCubic", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 2.14, bezier = "easeInOutCubic", style = "slide" })
...
hl.bind(
    "XF86MonBrightnessUp",
    hl.dsp.exec_cmd(
        "brightnessctl -e4 -n2 set 5%+ && qs ipc -c status-bar call events brightnessChanged"
    ),
